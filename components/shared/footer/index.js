...
export default function Footer() {
	return (
		<footer className="relative w-full bg-gradient-to-t from-azure-100 pt-20 pb-10 text-sm">
			<div className="w-full max-w-4xl mx-auto grid grid-cols-3 lg:grid-cols-3 text-azure-600 px-4 gap-y-8">
