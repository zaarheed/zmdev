                ...
                <div className="w-full max-w-prose mx-auto flex flex-col px-4">
                    ...
                    <div className="w-full flex flex-row justify-end mt-4">
                        <DefaultButton
                            ...
                            icon={(
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-hulk-500 duration-200 group-hover:scale-105" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
